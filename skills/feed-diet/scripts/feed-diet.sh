...
show_help() {
  ...
  🍽️  Feed Diet v0.1.0 — Audit Your Information Diet
  ═══════════════════════════════════════════════════
...
generate_report() {
  ...
  ITEMS_FILE_ENV="$items_file" SOURCE_LABEL_ENV="$source_label" python3 -c "
import json, sys, os
...
print(f'**Generated by:** Feed Diet v0.1.0')
print()
...
print()
print('---')
print('*Generated by Feed Diet v0.1.0 🍽️*')
print()
" 2>/dev/null
}
...
generate_digest() {
  ...
  ITEMS_FILE_ENV="$items_file" GOAL_ENV="$goal" SOURCE_LABEL_ENV="$source_label" python3 -c "
import json, sys, os
...
print('---')
print('*Feed Diet Weekly Digest v0.1.0 🍽️*')
print()
" 2>/dev/null
}
